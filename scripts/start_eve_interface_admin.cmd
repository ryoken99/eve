...
cd /d "%EVE_ROOT%"
start "Eve Web" /min powershell.exe -WindowStyle Minimized -ExecutionPolicy Bypass -Command "Set-Location -LiteralPath '%EVE_ROOT%'; python scripts\eve_gateway.py restart --host 127.0.0.1 --port 8787 --open"
