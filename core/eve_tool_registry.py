...
def _interest_evolution_schedule(args: dict) -> dict:
    return {
        "ok": True,
        "tool": "interest_evolution_schedule",
        "result": {
...
def _interest_registers_read(args: dict) -> dict:
    registers = read_daily_interest_registers(args.get("date") or None, max_chars_per_file=int(args.get("max_chars_per_file") or 12000))
    return {
        "ok": True,
